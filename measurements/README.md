# STM32F769 Measurements

## Widgets Light, SW, GCC O3

lv_timer_handler: 30.15 ms
refr_invalid_areas: 29.75 ms
flush_cb: 0.32 ms
...
flush_cb: 0.35 ms
render_time: 39.34 ms

## Screen Text, SW, GCC O3

lv_timer_handler: 77.8 ms
refr_invalid_areas: 77.41 ms
flush_cb: 0.32 ms
...
## Screen Text, DMA2D, GCC O3

lv_timer_handler: 76.76 ms
refr_invalid_areas: 76.37 ms
flush_cb: 0.33 ms
...
flush_cb: 0.35 ms
render_time: 64.76 ms

## Screen Text, SW, GCC Os

lv_timer_handler: 90.18 ms
refr_invalid_areas: 89.79 ms
flush_cb: 0.33 ms
...
flush_cb: 0.27 ms
render_time: 13.01 ms

## Screen Text, DMA2D, GCC Os

lv_timer_handler: 89.57 ms
